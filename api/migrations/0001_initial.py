# Generated by Django 4.2.7 on 2025-10-28 19:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('writer', 'Writer'), ('journal_manager', 'Journal Manager'), ('accountant', 'Accountant'), ('admin', 'Admin')], default='client', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submissionPaymentStatus', models.CharField(choices=[('payment_pending', 'Payment Pending'), ('payment_completed', 'Payment Completed'), ('payment_failed', 'Payment Failed')], default='payment_pending', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('click_trans_id', models.CharField(blank=True, max_length=255, null=True, unique=True, verbose_name='CLICK Trans ID')),
