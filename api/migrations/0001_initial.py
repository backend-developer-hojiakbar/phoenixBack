# Generated by Django 4.2.7 on 2025-07-02 07:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('journal_manager', 'Journal Manager'), ('admin', 'Admin')], default='client', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submissionTargetType', models.CharField(choices=[('journal', 'Journal'), ('conference', 'Conference'), ('special_issue', 'Special Issue')], default='journal', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('actionType', models.CharField(choices=[('USER_LOGIN', 'User Login'), ('USER_CREATED', 'User Created'), ('USER_UPDATED', 'User Updated'), ('USER_DELETED', 'User Deleted'), ('ARTICLE_SUBMITTED', 'Article Submitted'), ('ARTICLE_STATUS_CHANGED', 'Article Status Changed')], max_length=50)),
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, to='api.articletag'),
        ),
    ]
